...
>
    <div class="relative">
        ...
        "relative w-full text-left h-11 py-2.5 px-4 border border-gray bg-white py-2 pl-3 pr-10
        focus:border-primary-light focus:ring focus:ring-primary-light focus:ring-opacity-50 shadow-sm outline-none
        rounded-sm text-sm md:text-base placeholder-gray"
        ])>
