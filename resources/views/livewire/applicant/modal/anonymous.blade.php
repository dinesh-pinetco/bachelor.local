    ...
    <x-custom-modal wire:model="show">
        ...
        <div>
            <div class="space-y-3">
                ...
                <h4 class="text-center text-darkgray text-sm sm:text-base">
                    {{ __('are you sure you want an anonymous applicant?') }}
                </h4>
            </div>
        </div>
        ...
        <x-slot name="footer">
            <div class="flex justify-end space-x-2">
                <x-danger-button wire:click="AnonymousApplicant"  class="px-4 py-2">
                    {{ __('Yes') }}
                </x-danger-button>
                <x-primary-button wire:click="close" class="-mt-0">
                    {{ __('No') }}
                </x-primary-button>
