<div class="max-w-screen-xl w-full mx-auto">
        ...
        <div class="w-full flex items-center justify-between">
            ...
            @if(in_array($applicant->application_status, [\App\Enums\ApplicationStatus::TEST_PASSED, \App\Enums\ApplicationStatus::TEST_FAILED_CONFIRM]))
                <div wire:click="getTestResultPdf"
                     class="ml-8 px-4 py-2 flex items-center justify-center text-black bg-gray-400 hover:bg-gray-500 rounded-md cursor-pointer">
    ...
    @if(in_array($applicant->application_status, [\App\Enums\ApplicationStatus::TEST_TAKEN, \App\Enums\ApplicationStatus::TEST_FAILED]))
        <div class="inline-flex justify-center space-x-4 text-white p-4 bg-primary rounded-sm mx-auto">
            <svg class="text-white stroke-current w-5 h-5" width="24" height="24" viewBox="0 0 24 24" fill="none"
