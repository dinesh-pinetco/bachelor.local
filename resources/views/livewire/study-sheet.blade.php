                            ...
                            <div class="space-y-10">
                                ...
                                <div class="">
                                    <div class="flex form-check flex space-x-4">
                                        <input wire:model.lazy="studySheet.is_authorize" id="studySheet.is_authorize"
                                               ...
                                               type="checkbox">
                                        <label class="form-check-label inline-block text-gray-800" for="studySheet.is_authorize">
                                ...
                                <div class="mb-7">
                                    <div class="flex form-check flex space-x-4">
                                        <input wire:model.lazy="studySheet.privacy_policy" id="studySheet.privacy_policy"
                                               class="flex-shrink-0 w-5 h-5 mt-1 text-primary form-checkbox focus:border-primary-light focus:ring focus:ring-primary-light focus:ring-opacity-50 shadow-sm outline-none"
                                               type="checkbox">
                                        <label class="form-check-label inline-block text-gray-800" for="studySheet.privacy_policy">
