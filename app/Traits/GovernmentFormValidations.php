...
trait GovernmentFormValidations
{
    protected function rules(): array
    {
        return [
            ...
            'governmentForm.last_exam_year'             => ['integer', 'min:1900', 'max:2200'],
            'governmentForm.last_exam_month'            => ['integer', 'min:1', 'max:12'],
            ...
            'governmentForm.last_exam_grade'            => ['regex:/[0-9]{1}.[0-9]{1}/u'],
        ];
    }
