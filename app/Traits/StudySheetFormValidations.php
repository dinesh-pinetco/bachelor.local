...
trait StudySheetFormValidations
{
    ...
    {
        $specificCompanyPaymentValidation = 'required_if:studySheet.billing_address,1';
        ...
        return [
            //            'studySheet.payment' => ['required', Rule::in(StudySheetModel::payments())],
            ...
            /*'studySheet.delivery_address'                       => ['required', Rule::in(StudySheetModel::address())],
            'studySheet.custom_delivery_address'                => ['required_if:studySheet.delivery_address,2', 'nullable', 'array', 'max:6'],
            'studySheet.custom_delivery_address.name'           => ['required_if:studySheet.delivery_address,2', 'nullable', 'max:100'],
            'studySheet.custom_delivery_address.address'        => ['required_if:studySheet.delivery_address,2', 'max:255'],
            'studySheet.custom_delivery_address.postal_code'    => ['required_if:studySheet.delivery_address,2', 'max:50'],
            'studySheet.custom_delivery_address.location'       => ['required_if:studySheet.delivery_address,2', 'max:100'],
            'studySheet.custom_delivery_address.address_suffix' => ['nullable', 'max:20'],
            'studySheet.custom_delivery_address.country'        => ['required_if:studySheet.delivery_address,2', 'max:50'],*/
