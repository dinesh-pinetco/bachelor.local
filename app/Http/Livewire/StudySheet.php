...
class StudySheet extends Component
{
    ...
    public function mount()
    {
        ...
        if (! $this->applicant->study_sheet) {
            //            $this->studySheet->payment = 1;
            $this->studySheet->billing_address = 1;
            //            $this->studySheet->delivery_address = 1;
        }
    ...
    public function updated($propertyName)
    {
        ...
        /*if ($this->studySheet->delivery_address == StudySheetModel::ADDRESS_MAIN_ADDRESS) {
            $this->studySheet->custom_delivery_address = null;
        }*/
